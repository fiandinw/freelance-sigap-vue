  ...
  <main class="relative flex flex-col items-center px-12">
    ...
    <div>
      <ol class="list-decimal pl-4">
        ...
        <li>
          Pengerjaan jasa dimulai saat Anda menginput form e-order diantara jam
          06.00 – 17.00 WIB.
        </li>
        <li>
          Perhitungan pengerjaan jasa akan ditunda esok hari jika Anda menginput
          form e-order melebihi jam 17.00 WIB.
        </li>
        <li>
        ...
        <li>
          ...
          Official Music Video, Short Movie, Movie, Wedding Photo terbentuk atas
          1 tim dan memiliki bonus 1 hari untuk brainstorming konsep (terhitung
          estimasi pengerjaan jasa setelah 1 hari brainstorming konsep).
        </li>
        <li>
        ...
        <li>
          ...
          kategori yaitu sebanyak 1 kali, sedangkan batas revisi yang disediakan
          untuk Freelance Super Sigap dengan berbagai kategori yaitu sebanyak 1
          sampai 3 kali.
        </li>
        <li>
        ...
        <li>
          Jika Anda (sebagai klien) menyalahi aturan serta melanggar perjanjian
          diluar dari yang diinput pada form e-order, maka bersedia untuk
          menerima sanksi berupa dihanguskan request ordernya dan tidak ada
        ...
        <li>
          ...
          klien) melakukan tindakan tercela dengan kategori berat, maka bersedia
          untuk mengikuti prosedur hukum yang berlaku.
        </li>
        <li>
          Pelanggaran kategori ringan: Membuat risih, Mencemooh, Mencaci maki,
          Mengganggu privasi tanpa persetujuan diantara keduanya, Respon negatif
          yang berlebihan, Berlaku tidak waras.
        </li>
        <li>
